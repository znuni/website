    ...
    <div className="home-container">
      ...
      <div data-role="Header" className="home-header-container">
        <header className="home-header">
          ...
          <div className="home-container01">
            ...
            <PrimaryButton button="Request invite"></PrimaryButton>
          </div>
      ...
      <div className="home-main">
        ...
        <div className="home-hero">
          ...
          <img alt="image" src="/iphonex-1200w.png" className="home-image02" />
        </div>
        <img
          alt="image"
      ...
      <div className="home-clients">
        ...
        <img alt="image" src="/logo-1.svg" className="home-image03" />
        <img alt="image" src="/logo-4.svg" className="home-image04" />
        <img alt="image" src="/logo-3.svg" className="home-image05" />
        <img alt="image" src="/logo-5.svg" className="home-image06" />
        <img alt="image" src="/logo-6.svg" className="home-image07" />
        <div className="home-divider1"></div>
      </div>
      <div className="home-features">
        <h2 className="Headline2 home-text17">Tailor-made features</h2>
      ...
      <div className="home-testimonials">
        <div className="home-container08">
          <div className="home-container09">
            <img alt="image" src="/quote-mark.svg" className="home-image08" />
            <h1 className="home-text20 Headline2">
              Real Stories from Real Customers
            </h1>
            <span>Get inspired by these stories.</span>
            <div className="home-container10">
              <TestimonialsCard image_src="/logo-4.svg"></TestimonialsCard>
            </div>
          </div>
      ...
      <div className="home-feature2">
        <div className="home-container20">
          <h2 className="Headline2 home-text29">
        ...
        <div className="home-container21">
          <div className="home-container22">
            <h2 className="home-text31">
              <span className="Headline4">Connect with other students.</span>
              <br className="Headline4"></br>
              <span className="Headline4">From your school.</span>
              <br></br>
            </h2>
            <span className="home-text36">
              Don&apos;t miss out on the chance to be part of this exciting
              journey. Request an invite for your school now and secure your
              spot on the waiting list.
            </span>
            <span className="home-text37 Subtitle2">
              <span className="home-text38">Get the App</span>
            </span>
            <StoreBanner rootClassName="store-banner-root-class-name1"></StoreBanner>
            <PrimaryButton
      ...
      <div className="home-footer">
        <footer className="home-container24">
          <img alt="image" src="/logotype-light.svg" className="home-image13" />
          <span className="home-text39">znuni.club</span>
